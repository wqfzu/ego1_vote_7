...
HD_PWD='E:/XilinxExample/vote_7/vote_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TG.tcl -notrace
